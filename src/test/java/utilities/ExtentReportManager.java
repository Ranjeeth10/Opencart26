...
//		 
	...
	public void onFinish(ITestContext testContext) {
		 ...
		 * DefaultAuthenticator("ranjeethk10@gmail.com","Testpractice@26"));
		 * email.setSSLOnConnect(true); email.setFrom("ranjeethk10@gmail.com");//sender
		 * email.setSubject("Test Results");
		 * email.setMsg("Please find Attached Report...");
		 * email.addTo("ranjeethbalu2000@gmail.com"); // Receiver
